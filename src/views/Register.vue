      ...
      <div class="col-md-6 col-lg-5">
        ...
        <div class="card shadow-lg">
          <div class="card-body p-4">
            ...
            <form @submit.prevent="submitRegister">
              ...
              <div class="form-floating mb-3">
                <input v-model="form.username" type="text" class="form-control" 
                       id="registerUsername" placeholder="Usuario" required
                       :disabled="loading">
              ...
              <div class="form-floating mb-3">
                <input v-model="form.email" type="email" class="form-control" 
                       id="registerEmail" placeholder="Correo electrónico" required
                       :disabled="loading">
              ...
              <div class="form-floating mb-3">
                <input v-model="form.confirmPassword" type="password" class="form-control" 
                       id="registerConfirmPassword" placeholder="Confirmar contraseña" required
                       :disabled="loading">
              ...
              <div class="form-check mb-3">
                <input v-model="form.agreedToTerms" class="form-check-input" type="checkbox" 
                       id="agreedToTerms" required :disabled="loading">
            ...
            <!-- Login Link -->
            <RouterLink to="/login" class="btn btn-outline-primary w-100">
        ...
        <p class="text-center text-muted mt-4 small">
          <i class="bi bi-shield-lock"></i> Tus datos están protegidos
        </p>
      </div>
    </div>
  </div>
...
const submitRegister = async () => {
  ...
  try {
    ...
    errorMessage.value = error.message || 'Error al registrarse. Intenta de nuevo.'
